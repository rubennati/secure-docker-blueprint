...
| 2026-05-02 | App Chain | `apps/heimdall` | Env file aligned with standard: section header, TZ examples comment, inverted ALLOW_INTERNAL_REQUESTS comment fixed. Startup verified on clean install (`v2.6.3-ls312`). UI reachable via Traefik. | — |
