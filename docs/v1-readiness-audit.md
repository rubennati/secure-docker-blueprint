...
4. **Commercial model** — durable fields rather than volatile prices: `free
   ...
   **The system is complete; the research is a standing activity.** Everything W8 asked
   ...
   What continues is reading upstream terms, one stack at a time. **Coverage: 33 of 98**
   — 31 with facts, 2 checked and clear. That figure is coverage, not a defect and not a
