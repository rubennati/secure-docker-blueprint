			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Keycloak', link: '/infrastructure/keycloak/' },
				...
				},
				{
					...
					items: [
						...
						{ label: 'Adminer', link: '/applications/adminer/' },
						{ label: 'BookStack', link: '/applications/bookstack/' },
						{ label: 'Cal.diY', link: '/applications/caldiy/' },
						{ label: 'Dashy', link: '/applications/dashy/' },
						{ label: 'Documenso', link: '/applications/documenso/' },
						{ label: 'Easy!Appointments', link: '/applications/easyappointments/' },
						{ label: 'Ghost', link: '/applications/ghost/' },
						{ label: 'Heimdall', link: '/applications/heimdall/' },
						{ label: 'Homarr', link: '/applications/homarr/' },
						{ label: 'Homepage', link: '/applications/homepage/' },
						...
						{ label: 'OpenProject', link: '/applications/openproject/' },
