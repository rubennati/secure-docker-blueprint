...
| `business/invoiceninja` | `business` | `preview` | `scaffolded` | `APP_TAG=5.13.16` | `2026-04-14` | `aligned-with-deviations` | `documented` | `documented` | `not-tested` | `pinned-check-needed` | [README](business/invoiceninja/README.md), [UPSTREAM](business/invoiceninja/UPSTREAM.md) |
