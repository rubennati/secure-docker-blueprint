...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `core/onlyoffice` | `core` | `ready` | `baseline-aligned` | `APP_TAG=9.3.1.2` | `2026-06-14` | `aligned-with-deviations` | `documented` | `partial` | `unknown` | `pinned-current-known` | [README](core/onlyoffice/README.md), [UPSTREAM](core/onlyoffice/UPSTREAM.md) |
| `apps/vaultwarden` | `apps` | `ready` | `baseline-aligned` | `APP_TAG=1.36.0` | `2026-06-14` | `aligned-with-deviations` | `partial` | `partial` | `unknown` | `pinned-current-known` | [README](apps/vaultwarden/README.md), [UPSTREAM](apps/vaultwarden/UPSTREAM.md) |
| `business/invoiceninja` | `business` | `preview` | `scaffolded` | `APP_TAG=5.13.24` | `2026-06-14` | `aligned-with-deviations` | `documented` | `documented` | `not-tested` | `pinned-current-known` | [README](business/invoiceninja/README.md), [UPSTREAM](business/invoiceninja/UPSTREAM.md) |
