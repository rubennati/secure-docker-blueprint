...
- [ ] Batches H–V, each its own pull request. **H, I and K shipped** (Gotify,
      ciao, Wiki.js, Shlink, Kopia — all `scaffolded`, verified on the image,
      not behind Traefik); J is open as a pull request:
