...
- [ ] Batches H–V, each its own pull request. **H, I and M shipped** — Gotify,
      ciao, Wiki.js, Shlink and Plausible CE, all `scaffolded`, verified on the
      image and not yet behind Traefik. J, K and L are open pull requests.
