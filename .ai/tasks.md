...
- [ ] Batches H–V, each its own pull request. **H, I and N shipped** — Gotify,
      ciao, Wiki.js, Shlink and Checkmate, all `scaffolded`, verified on the
      image and not yet behind Traefik. J, K, L and M are open pull requests.
